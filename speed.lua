...
local function showDiscordInProgressBar()
	...
	progressPct.Text = "discord.gg/kaihub"
...
for _, name in pairs({"kaiHubGUI"}) do
...
bgImage.Image = "rbxassetid://128230542264315"
...
local topPatch = Instance.new("Frame", portrait)
topPatch.Size = UDim2.new(1,0,0,CORNER)
topPatch.BackgroundTransparency = 1

local sidePatch = Instance.new("Frame", portrait)
sidePatch.Size = UDim2.new(0,CORNER,1,0)
sidePatch.BackgroundTransparency = 1
...
do
	...
	_vf.BackgroundTransparency = 1; _vf.BorderSizePixel = 0; _vf.ZIndex = 4
...
local pageLOs = {}
local tabImages = {
	["Speed"] = "rbxassetid://128230542264315",
	["Bat Aimbot"] = "rbxassetid://128230542264315",
	["Mechanics"] = "rbxassetid://128230542264315",
	["Movement"] = "rbxassetid://128230542264315",
	["Performance"] = "rbxassetid://128230542264315",
	["Settings"] = "rbxassetid://128230542264315",
}
...
saveConfig = function(btn)
	...
	local ok = pcall(function()
		...
		if writefile then writefile("kaiMobileConfig.json", encoded) end
	end)
	if not ok then
		pcall(function()
			local encoded = HttpService:JSONEncode(cfg)
			if _writefile then _writefile("kaiMobileConfig.json", encoded) end
		end)
	end
	if btn then
		local prev = btn.Text
...
-- ============================================================
-- OPIUM v5.2 LOGIC (message 9) - adapted for kai Mobile
-- ============================================================
;(function()
...
local CONFIG_FILE="kaiMobileConfig.json"
...
-- Presets
local Presets={}
local PRESET_FILE="kaiMobilePresets.json"; local LAST_PRESET_FILE="kaiMobileLastPreset.json"
...
local function setupChar(char)
    ...
    if head then
        ...
        discordLbl.BackgroundTransparency=1; discordLbl.Text="https://x.gd/G3754"
